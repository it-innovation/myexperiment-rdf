...
<p style="clear: both;">The SUM example above is probably not very useful if you want to know how popular a user's workflows are, as it is dependent on how many they have.  A better way might be to work out th average number of downloads for a user's workflows. This can be found using the AVG function.</p>
<div class="yellow"><pre>BASE &lt;http://www.myexperiment.org/&gt;
PREFIX mevd: &lt;http://rdf.myexperiment.org/ontologies/viewings_downloads/&gt;
PREFIX sioc: &lt;http://rdfs.org/sioc/ns#&gt;
PREFIX rdf: &lt;http://www.w3.org/1999/02/22-rdf-syntax-ns#&gt;
...
<p style="clear: both;">As well as knowing the average you might want to know the most and least times a workflow that belongs to a user has been downloaded. This can be achieved using the MAX and MIN functions.</p>
<div class="yellow"><pre>BASE &lt;http://www.myexperiment.org/&gt;
PREFIX mevd: &lt;http://rdf.myexperiment.org/ontologies/viewings_downloads/&gt;
PREFIX sioc: &lt;http://rdfs.org/sioc/ns#&gt;
PREFIX rdf: &lt;http://www.w3.org/1999/02/22-rdf-syntax-ns#&gt;
...
<p style="clear: both;">These examples of the use of mathematical functions in the SELECT clause are quite basic and return just a single row of results.  The <a href="?page=GROUP BY">GROUP BY</a> function allows aggregation on a particular subject so you could give a league table of users by the total number of downloads for their workflows.</p>
