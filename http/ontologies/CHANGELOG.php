...
<ul class="changelog">
  <li><b>27/05/2010</b> Added various has-x properties to allow users in the Linked Data world to more easily navigate around myExperiment entities.</li>
  <li><b>20/05/2010</b> Consensus seems that xsd:anyURI should only be used if the resource is non-resolvable therefore have switched to unrestricted ObjectProperty where URIs can be resolved.  Also removed mebase:human-start-page as it is covered by the foaf:homepage in the description of the graph.</li>
