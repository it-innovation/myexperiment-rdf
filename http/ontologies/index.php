...
<p>For most of the classes described in Fig.2 <a href="/example/" title="RDF Examples">RDF examples</a> are available.  Modules reuse terms from other modules as well as terms borrowed for the ontologies/schemas previously described.  Fig.3 diagrams of how modules borrow from each other with each arrow going from the borrowed-from module/ontology/schema to the borrowing module. The &quot;<a href="specific/" title="Base Ontology Module">Base</a>&quot; module is built open by all the other modules (except SNARM). The &quot;<a href="specific/" title="Specific Ontology Module">Specific</a>&quot; module is slightly different as it imports all the other modules below it.  This allows a single URI to be referred to when importing the myExperiment ontology set. Documentation explaining how all the ontology's classes and properties from the ontology can be used is available <a href="http://rdf.myexperiment.org/ontologies/specification" title="Specification of Modularized Ontology Set">here</a>.</p>
<div align="center">
