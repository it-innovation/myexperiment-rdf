...
<p>A Relationship is made up of an RDF, subject, predicate and object. URI is a <a href="http://en.wikipedia.org/wiki/Universally_unique_identifier#Version_5_.28SHA-1_hash.29">UUID version 5</a> URN (i.e. an SHA-1 hash) generated from the concatenation of the subject, predicate and object URIs.  (N.B. So that anyone can generate the same URN for the same triple, no namespace parameter is provided to the UUID generating function).  This ensures that all identical relationships have the same URI, essentially indexing relationships to make it easier to find packs that share the same relationships.</p>
