		...
		if ($dataflow['id']){
	        ...
	        foreach ($dataflow as $cnum => $comp){
				...
				elseif (in_array($prop['type'],$dturi)){
					$components.="        <".$prop['type']." rdf:datatype=\"&xsd;anyURI\">".xmlentities($prop['value'])."</".$prop['type'].">\n";
				}
