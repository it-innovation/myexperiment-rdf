...
PREFIX ore: <http://www.openarchives.org/ore/terms/>";
	...
	$mappings['announcements']=array('id'=>'url','title'=>'dcterms:title', 'user_id'=>'&User|mebase:has-announcer', 'created_at'=>'dcterms:created', 'updated_at'=>'dcterms:modified', 'body'=>'mebase:text');
        ...
        $mappings['friendship_invitations']=array('id'=>'url','user_id'=>'&User|mebase:has-requester','friend_id'=>'&User|mebase:has-accepter','created_at'=>'dcterms:created','accepted_at'=>'mebase:accepted-at','message'=>'mebase:text','email'=>'@-mbox_sha1sum|foaf:mbox_sha1sum','token'=>'@request_token|mebase:request-token');
       	$mappings['groups']=array('id'=>'url','user_id'=>'&User|sioc:has_owner', 'created_at'=>'dcterms:created', 'updated_at'=>'dcterms:modified','title'=>'sioc:name','description'=>'dcterms:description', 'auto_accept'=>'mebase:auto-accept','annotations'=>'@&getAnnotations|');
        ...
        $mappings['local_pack_entries']=array('id'=>'url','pack_id'=>'&Pack|ore:proxyIn','proxy_for'=>'@getProxyFor|ore:proxyFor','comment'=>'dcterms:description','user_id'=>'&User|sioc:has_owner','created_at'=>'dcterms:created', 'updated_at'=>'dcterms:modified');
       	...
       	$mappings['membership_invitations']=array('id'=>'url','requester'=>'@getRequester|mebase:has-requester','accepter'=>'@-getAccepter|mebase:has-accepter','created_at'=>'dcterms:created','accepted_at'=>'mebase:accepted-at','message'=>'mebase:text','email'=>'@-mbox_sha1sum|foaf:mbox_sha1sum','token'=>'@request_token|mebase:request-token');
