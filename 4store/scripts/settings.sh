...
export ENTITIES=( announcements attributions citations comments content_types creditations experiments favourites files friendships friendship_invitations groups group_announcements jobs licenses local_pack_entries memberships membership_invitations messages packs ratings remote_pack_entries reviews tags taggings taverna_enactors users vocabularies workflows workflow_versions )
