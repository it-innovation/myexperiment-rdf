...
export ENTITIES=( announcements attributions citations comments content_types creditations experiments favourites files friendships groups group_announcements jobs licenses local_pack_entries memberships messages packs policies ratings remote_pack_entries reviews runners tags taggings users vocabularies workflows workflow_versions )
